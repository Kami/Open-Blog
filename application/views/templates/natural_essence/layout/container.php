...
<div id="wrapper">
	<div id="container">
		<div class="title">
			<?php $this->load->view('templates/natural_essence/layout/header'); ?>
		</div>
		
		<div class="header"></div>
		
		<div class="navigation">
			<?php $this->load->view('templates/natural_essence/layout/menu/navigation'); ?>
		</div>
		...
		<div class="main" id="two-columns">
			<div class="col2">
				<div class="left">
					<div class="content">
						<?php $this->load->view('templates/natural_essence/layout/pages/' . $page); ?>
					</div>
				</div>
				...
				<div class="right">
					<div class="content">
						...
						<?php $this->load->view('templates/natural_essence/layout/menu/sidebar'); ?>
					</div>
				</div>
			...
			<div class="footer">
				...
				<?php $this->load->view('templates/natural_essence/layout/footer'); ?>
			</div>
		</div>
	</div>
</div>
