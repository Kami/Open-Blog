...
<? if ($this->system->settings['allow_registrations'] == 1): ?>
	<p><?=lang('registration_description');?></p>
			 	...
			 	<fieldset id="name">
			 		...
			 		<table>
			 			<tr>
			 				...
			 				<td><input name="username" id="username" type="text" value="<?=$this->validation->username;?>" size="15" class="styled" /> <font color="red">*</font></td>
			 			</tr>
			 			<tr>
			 	...
			 	<fieldset id="contact_info">
			 		...
			 		<table>
			 			<tr>
			 				...
			 				<td><input name="email" id="email" type="text" value="<?=$this->validation->email;?>" size="25" class="styled" /> <font color="red">*</font></td>
			 			</tr>
			 			<tr>
			 			...
			 			<tr>
			 				...
			 				<td><textarea name="about_me" id="about_me" rows="10" cols="30" class="styled"><?=$this->validation->about_me;?></textarea></td>
			 			</tr>
			 		</table>
			 	</fieldset>
			 </td>
