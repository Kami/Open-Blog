...
<div class="wrapper">
	...
	<div class="container">
		...
		<div class="main">		
			...
			<div class="content">
				<?php $this->load->view('templates/contaminated/layout/header'); ?>
				
				<?php $this->load->view('templates/contaminated/layout/pages/' . $page); ?>
			</div>

			<div class="sidenav">
				<?php $this->load->module_language('blog', 'sidebar'); ?> 
				<?php $this->load->view('templates/contaminated/layout/menu/sidebar'); ?>
			</div>
		...
		<div class="footer">
			...
			<?php $this->load->view('templates/contaminated/layout/footer'); ?>	
		</div>
