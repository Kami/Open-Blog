...
<div class="login">
	...
	<table class="login">
		<form action="<?php echo site_url('user/login'); ?>" method="post">	
			<tr><td><?php echo lang('form_username'); ?>&nbsp;</td> <td><input name="username" id="username" type="text" size="15" /></td></tr>
			<tr><td><?php echo lang('form_password'); ?>&nbsp;</td> <td><input name="password" id="password" type="password" size="15" /></td></tr>
