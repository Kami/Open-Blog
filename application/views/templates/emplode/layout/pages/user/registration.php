...
<?php if ($this->system_library->settings['allow_registrations'] == 1): ?>
	...
	<?php endif; ?>
		...
		<tr>
			 <td colspan="2">
			 	<fieldset id="name" class="profile">
			 		<legend class="profile"><?php echo lang('form_name'); ?></legend>
			 		<table>
			 			<tr>
		...
		<tr>
			 <td colspan="2">
			 	<fieldset id="password" class="profile">
			 		<legend class="profile"><?php echo lang('form_password'); ?></legend>
			 		<table>
			 			<tr>
		...
		<tr>
			 <td colspan="2">
			 	<fieldset id="contact_info" class="profile">
			 		<legend class="profile"><?php echo lang('form_contact_info'); ?></legend>
			 		<table>
			 			<tr>
			 			...
			 			<tr>
			 				<td width="150px" style="vertical-align: top"><?php echo lang('form_about_me'); ?></td>
