		...
		<div class="post_body">
			<p><?php echo lang('posts_description'); ?></p>
				...
				<tr>
					...
					<th class="admin"><?php echo lang('th_categories'); ?></th>
				...
				<?php if ($posts): ?>
					...
					<tr>
						...
						<td class="admin"><?php echo anchor(post_url($post['url_title'], $post['date_posted']), $post['title'], array('target' => '_blank')); ?></td>
						<td class="admin"><?php echo categories_url($post['categories']); ?></td>
