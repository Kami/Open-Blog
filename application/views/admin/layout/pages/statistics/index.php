		...
		<div class="post_body">
			...
			<p>
				...
				<?php if ($post_with_most_comments): ?>
					<?php echo lang('most_popular_post'); ?> <a href="<?php echo site_url('blog/post/' . post_url($post_with_most_comments['url_title'], $post_with_most_comments['date_posted'])); ?>" target="_blank"><strong><?php echo $post_with_most_comments['title']; ?></strong></a> (<strong><?php echo $post_with_most_comments['comments_count']; ?></strong> <?php echo lang('comments_total'); ?>)<br />
				<?php endif; ?>
				<?php echo lang('categories'); ?> <strong><?php echo $categories_count; ?></strong><br />
				<?php if ($category_with_most_posts): ?>	
					<?php echo lang('category_with_most_posts'); ?> <a href="<?php echo site_url('blog/category/' . $category_with_most_posts['url_name']); ?>" target="_blank"><strong><?php echo $category_with_most_posts['name']; ?></strong></a> (<strong><?php echo $category_with_most_posts['posts_count']; ?></strong> <?php echo lang('posts_total'); ?>)<br />
				<?php endif; ?>
