	...
	function _execute($row, $rules, $postdata = NULL, $cycles = 0)
	{
		...
		foreach ($rules As $rule)
		{
			...
			{			
				...
				// Build the error message
				$mparam = ( ! isset($this->_field_data[$param])) ? $param : $this->_field_data[$param]['label'];                
				$message = sprintf($line, $this->_translate_fieldname($row['label']), $this->_translate_fieldname($mparam['label'])); 
